...
<html lang="en">
  ...
  <body>
		<div class="container w-75">
  			...
  			<h1 class="text-center">Edit the question #${requestScope.questiontodelete.kysymys_id}</h1>

			<div class="w-50 m-auto">
				<form action="/rest/admin/delete" method="post">
					<input type="hidden" value="">
					<div class="mb-3 row">
			    		<label for="kysymys_id" class="col-sm-3 col-form-label">Question ID</label>
			    		<div class="col-sm-9">
							<input type="text" class="form-control" name="kysymys_id" id="kysymys_id" value="${requestScope.questiontodelete.kysymys_id}" readonly>
			    		</div>
			    	</div>
			    	<div class="mb-3 row">
			    		<label for="kysymys" class="col-sm-3 col-form-label">Question</label>
			    		<div class="col-sm-9">
			    			<input type="text" class="form-control" name="kysymys" id="kysymys" value="${requestScope.questiontodelete.kysymys}" readonly>
			    		</div>
			    	</div>
